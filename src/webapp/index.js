...
const explorerURL = 'https://frankenstein-explorer.oneledger.network'
const coin = "OLT"
...
function renderApp() {
    ...
    render([
        ...
        h('nav.navbar.navbar-default', [
            h('h1.container-fluid', `Frankenstein ${coin} Faucet`)
        ]),
        ...
        h('section.container', [
            ...
            h('div.panel.panel-default', [
                ...
                h('div.panel-body', [
                    ...
                    h('button.btn.btn-warning', `1 ${coin}`, {
                        style: {
                            margin: '4px'
                        },
                        // disabled: state.userAddress ? null : true,
                    ...
                    h('button.btn.btn-warning', `10 ${coin}`, {
                        style: {
                            margin: '4px'
                        },
                        // disabled: state.userAddress ? null : true,
                    ...
                    h('button.btn.btn-warning', `100 ${coin}`, {
                        style: {
                            margin: '4px'
                        },
                        // disabled: state.userAddress ? null : true,
            ...
            h('div.panel.panel-default', [
                ...
                h('div.panel-body', {
                    ...
                    state.transactions.map((txHash) => {
                        return link(`${explorerURL}/tx/${txHash}`, txHash)
                    })
                ))
            ])
